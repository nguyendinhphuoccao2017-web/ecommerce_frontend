...
## 3. UI/UX Polishing (Hiệu ứng tinh chỉnh)
...
- **Bag Screen My Bag Popup:** Điều chỉnh `height` của `PopupMenuItem` (từ 48 xuống 36) để thanh divider hiển thị cân đối, nằm chuẩn xác giữa Tên Sản phẩm và phần thông tin kích thước (Color & Size) đúng y hệt như bản thiết kế Figma.
