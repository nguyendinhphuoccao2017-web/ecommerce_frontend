    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          _buildCategoryCard(context, 'New', 'assets/images/nav_bar/new.png'),
          const SizedBox(height: 16),
          _buildCategoryCard(context, 'Clothes', 'assets/images/nav_bar/clothes.png'),
          const SizedBox(height: 16),
          _buildCategoryCard(context, 'Shoes', 'assets/images/nav_bar/shoes.png'),
          const SizedBox(height: 16),
          _buildCategoryCard(context, 'Accesories', 'assets/images/nav_bar/accesories.png'),
        ],
      ),
    );
  }
